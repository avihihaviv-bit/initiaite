...
export function WeeklyGrid() {
  ...
  return (
    <div className="rounded-xl2 bg-white p-4 shadow-card">
      <h3 className="mb-3 text-sm font-bold text-ink">This week</h3>
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 rounded-xl px-1 py-2.5 transition active:scale-95 ${
                today ? 'bg-primary-500 text-white' : 'bg-gray-50 text-ink hover:bg-gray-100'
              }`}
            >
              ...
              {d.hasEntries ? (
                ...
                <span className={`text-[11px] ${today ? 'text-primary-50' : 'text-gray-300'}`}>—</span>
              )}
            </button>
          );
        })}
