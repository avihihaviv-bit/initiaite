import { BarChart3, Bot, Calendar, Flame, Gift, Home, ListChecks, Settings, Users } from 'lucide-react'
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'chores', path: '/chores', label: 'My Chores', icon: ListChecks, emoji: '✅' },
  { id: 'family', path: '/family', label: 'Family', icon: Users, emoji: '👨‍👩‍👧' },
  { id: 'calendar', path: '/calendar', label: 'Calendar', icon: Calendar, emoji: '📅' },
  { id: 'rewards', path: '/rewards', label: 'Rewards', icon: Gift, emoji: '🏆' },
  { id: 'streaks', path: '/streaks', label: 'Streaks', icon: Flame, emoji: '🔥' },
...
export const MOBILE_PRIMARY_IDS = ['home', 'chores', 'calendar', 'rewards']
