...
const I18N = {
    HE: {
        ...
        gpsError: "לא ניתן לאתר מיקום",

        fieldToolsHeader: "כלי תיעוד שטח",
        moduleSuspectHeader: "תיעוד חשוד ורכב",
        recentQueryLabel: "קישור לבדיקה אחרונה",
        recentQueryNone: "ללא",
        recentQueryLinkedPrefix: "מקושר לבדיקה:",
        suspectBlockTitle: "חשוד",
        behaviorLabel: "התנהגות חשודה",
        behaviorPlaceholder: "תאר את ההתנהגות שעוררה חשד...",
        clothingLabel: "תיאור לבוש",
        clothingPlaceholder: "לדוגמה: חולצה שחורה, מכנסי ג'ינס",
        locationNearLabel: "נמצא בסמוך ל",
        locationNearPlaceholder: "כתובת או נקודת ציון",
        addSuspectBtn: "הוסף חשוד נוסף",
        attachedVehiclesLabel: "רכבים מעורבים",
        vehicleBlockTitle: "רכב",
        vehicleMakePlaceholder: "יצרן ודגם",
        vehiclePlatePlaceholder: "מספר רישוי",
        vehicleColorPlaceholder: "צבע",
        addVehicleBtn: "הוסף רכב",
        noVehiclesAttached: "אין רכבים מצורפים",
        saveDocBtn: "שמור תיעוד",
        docSaved: "התיעוד נשמר בהצלחה",

        moduleCheckpointHeader: "תיעוד מחסומים ובדיקות רכב",
        driverDetailsLabel: "פרטי נהג",
        driverIdPlaceholder: "ת.ז. נהג",
        driverNamePlaceholder: "שם נהג",
        licenseStatusLabel: "סטטוס רישיון",
        licenseValid: "תקף",
        licenseExpired: "פקוע",
        licenseSuspended: "מושעה",
        lprScanBtn: "סרוק לוחית רישוי (LPR)",
        lprScanning: "סורק...",
        searchFindingsLabel: "ממצאי חיפוש",
        findingClear: "נקי",
        findingContraband: "נמצא רכוש חשוד",
        findingWeapons: "נמצא נשק",

        moduleCitationsHeader: "דוחות אכיפה",
        trafficTicketHeader: "דוח תנועה",
        offenseSpeeding: "מהירות מופרזת",
        offensePhone: "שימוש בטלפון נייד",
        offenseStopSign: "אי עצירה בתמרור עצור",
        fineAmountPlaceholder: "סכום הקנס (₪)",
        envTicketHeader: "דוח איכות סביבה",
        offenseLittering: "השלכת פסולת",
        offenseNoise: "הקמת רעש",
        ticketLocationPlaceholder: "מיקום העבירה",

        moduleIntelHeader: "דוח ידיעה / קשר עם אזרח",
        intelReportHeader: "דוח ידיעה",
        intelPlaceholder: "תעד ידיעה מודיעינית...",
        businessCheckHeader: "ביקורת עסקים",
        businessNamePlaceholder: "שם העסק",
        ownerIdPlaceholder: "ת.ז. בעל העסק",
        complianceLabel: "בדיקת עמידה בתנאים",
        complianceBusinessLicense: "רישיון עסק בתוקף",
        complianceAlcohol: "רישיון מכירת אלכוהול",
        complianceHours: "עמידה בשעות פעילות מותרות",
    ...
    EN: {
        ...
        fieldToolsHeader: "Field Documentation Tools",
        moduleSuspectHeader: "Suspect & Vehicle Documentation",
        recentQueryLabel: "Link Recent Query",
        recentQueryNone: "None",
        recentQueryLinkedPrefix: "Linked to query:",
        suspectBlockTitle: "Suspect",
        behaviorLabel: "Suspicious Behavior",
        behaviorPlaceholder: "Describe the behavior that raised suspicion...",
        clothingLabel: "Clothing Description",
        clothingPlaceholder: "e.g., black shirt, jeans",
        locationNearLabel: "Located Near",
        locationNearPlaceholder: "Address or landmark",
        addSuspectBtn: "Add Another Suspect",
        attachedVehiclesLabel: "Attached Vehicles",
        vehicleBlockTitle: "Vehicle",
        vehicleMakePlaceholder: "Make & Model",
        vehiclePlatePlaceholder: "License Plate",
        vehicleColorPlaceholder: "Color",
        addVehicleBtn: "Add Vehicle",
        noVehiclesAttached: "No vehicles attached",
        saveDocBtn: "Save Documentation",
        docSaved: "Documentation saved successfully",

        moduleCheckpointHeader: "Checkpoint & Vehicle Checks",
        driverDetailsLabel: "Driver Details",
        driverIdPlaceholder: "Driver ID",
        driverNamePlaceholder: "Driver Name",
        licenseStatusLabel: "License Status",
        licenseValid: "Valid",
        licenseExpired: "Expired",
        licenseSuspended: "Suspended",
        lprScanBtn: "Scan License Plate (LPR)",
        lprScanning: "Scanning...",
        searchFindingsLabel: "Search Findings",
        findingClear: "Clear",
        findingContraband: "Contraband Found",
        findingWeapons: "Weapons Found",

        moduleCitationsHeader: "Citations & Tickets",
        trafficTicketHeader: "Traffic Ticket",
        offenseSpeeding: "Speeding",
        offensePhone: "Using Mobile Phone",
        offenseStopSign: "Stop Sign Violation",
        fineAmountPlaceholder: "Fine Amount (₪)",
        envTicketHeader: "Environmental Ticket",
        offenseLittering: "Littering",
        offenseNoise: "Noise Pollution",
        ticketLocationPlaceholder: "Offense Location",

        moduleIntelHeader: "Intelligence & Field Reports",
        intelReportHeader: "Intelligence Report",
        intelPlaceholder: "Document field intelligence...",
        businessCheckHeader: "Business / Licensing Check",
        businessNamePlaceholder: "Business Name",
        ownerIdPlaceholder: "Owner ID",
        complianceLabel: "Compliance Check",
        complianceBusinessLicense: "Valid Business License",
        complianceAlcohol: "Alcohol Sale License",
        complianceHours: "Compliant Operating Hours",
